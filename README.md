...
2. Open the presentation:
    ...
    ```reveal-md demo.md --theme https://rawgit.com/puzzle/pitc-revealjs-theme/1.0.1/theme/puzzle.css```
...
2. Add script in your `packages.json`:
    ...
    "scripts": {
        ...
        "reveal-md": "reveal-md demo.md --theme https://rawgit.com/puzzle/pitc-revealjs-theme/1.0.1/theme/puzzle.css"
    },
    ...
    ```
